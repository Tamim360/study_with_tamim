...
const Subscribe = () => {
    return (
        <div className="p-2 pt-8 bg-heroBg bg-center">
            ...
            <p className="w-max mx-auto text-xs rounded-full font-bold bg-violet-500/50 text-violet-800 p-1 px-2 ">SUBSCRIBE</p>
            <h2 className="text-2xl font-bold text-center mt-3">Subscribe our newsletter.</h2>
