      ...
      <div className="max-w-2xl mx-auto my-8">
        ...
        >
          ...
          <div className="collapse-content">
            <p>
              <span className="font-bold">Study with Tamim</span> is a Online
              Course selling institution for the students of the University and
              college to learn Quran, Hadith, Fiqh and more with very low cost.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="collapse-content">
            <p>
              We provide this type of online learning that will make you
